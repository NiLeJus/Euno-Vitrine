...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFFFD889);
  late Color secondary = const Color(0xFFA17248);
...
class ThemeTypography extends Typography {
  ...
  TextStyle get displayLarge => GoogleFonts.robotoCondensed(
  ...
  TextStyle get displayMedium => GoogleFonts.robotoCondensed(
        color: theme.primaryText,
        fontWeight: FontWeight.w600,
        fontSize: 44.0,
      );
  ...
  TextStyle get displaySmall => GoogleFonts.robotoCondensed(
        color: theme.primaryText,
        fontWeight: FontWeight.w600,
        fontSize: 36.0,
      );
  ...
  TextStyle get headlineLarge => GoogleFonts.robotoCondensed(
        color: theme.primaryText,
        fontWeight: FontWeight.w600,
        fontSize: 32.0,
      );
  ...
  TextStyle get headlineMedium => GoogleFonts.robotoCondensed(
        color: theme.primaryText,
        fontWeight: FontWeight.w600,
        fontSize: 28.0,
      );
  ...
  TextStyle get headlineSmall => GoogleFonts.robotoCondensed(
        color: theme.primaryText,
        fontWeight: FontWeight.w600,
        fontSize: 24.0,
      );
  ...
  TextStyle get titleLarge => GoogleFonts.robotoCondensed(
        color: theme.primaryText,
        fontWeight: FontWeight.w600,
        fontSize: 20.0,
      );
  ...
  TextStyle get titleMedium => GoogleFonts.robotoCondensed(
        color: theme.primaryText,
        fontWeight: FontWeight.w600,
        fontSize: 18.0,
      );
  ...
  TextStyle get titleSmall => GoogleFonts.robotoCondensed(
        color: theme.primaryText,
        fontWeight: FontWeight.w600,
        fontSize: 16.0,
      );
