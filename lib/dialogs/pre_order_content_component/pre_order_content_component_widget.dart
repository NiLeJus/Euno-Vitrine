...
import 'pre_order_content_component_model.dart';
export 'pre_order_content_component_model.dart';

class PreOrderContentComponentWidget extends StatefulWidget {
  const PreOrderContentComponentWidget({
    super.key,
    bool? isModal,
  ...
  @override
  State<PreOrderContentComponentWidget> createState() =>
      _PreOrderContentComponentWidgetState();
}

class _PreOrderContentComponentWidgetState
    extends State<PreOrderContentComponentWidget> {
  late PreOrderContentComponentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PreOrderContentComponentModel());
                      ...
                      child: Align(
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                'Réservez votre Euno dès aujourd’hui !',
                              ...
                              Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    0.0, 12.0, 0.0, 24.0),
                                child: Text(
                                  'En remplissant ce formulaire, vous manifestez votre intérêt pour la première série de production. Aucun paiement n’est requis pour cette étape.',
                                        ...
                                        Padding(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              Expanded(
                                                child: AutoSizeText(
                                                  'Euno n’est pas un simple robot : c’est un compagnon de tous les jours, un confident attentif, un gardien doux et évolutif.  Sa mission ? Accompagner votre enfant dans ses découvertes, ses émotions et ses routines — de bébé à adolescent. ',
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .bodyMedium
                                                      .override(
