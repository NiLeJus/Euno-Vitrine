...
import 'contact_form_modal_model.dart';
export 'contact_form_modal_model.dart';

class ContactFormModalWidget extends StatefulWidget {
  const ContactFormModalWidget({super.key});

  @override
  State<ContactFormModalWidget> createState() => _ContactFormModalWidgetState();
}

class _ContactFormModalWidgetState extends State<ContactFormModalWidget> {
  late ContactFormModalModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ContactFormModalModel());
                        ...
                        children: [
                          ...
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                0.0, 12.0, 0.0, 24.0),
                            child: Text(
                              'Une question ? Une idée ? Une envie de collaborer ? Nous serons ravis de vous lire. Remplissez le formulaire ci-dessous ou contactez-nous directement par email.',
                              style: FlutterFlowTheme.of(context)
                                  .labelMedium
                                  .override(
